"""
agent/tests/test_dpapi.py — every `<behavior>` bullet for `agent/dpapi.py`
(40-03-PLAN.md Task 2).

D-20's own trap: the `dpapi`-marked tests below are Windows-only by design and
...
like proof (D-20). The off-Windows behaviour tests below are deliberately left
...
# ---------------------------------------------------------------------------
# Real-syscall round trip — Windows only, marked `dpapi` per D-20.
# ---------------------------------------------------------------------------
